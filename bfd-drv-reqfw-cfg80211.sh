...
if [ "${CHIPVER}" == 43236b ] || [ "${CHIPVER}" == 43238b ] ; then
	export BUILDCFG_COMMON=dhd-cdc-usb-reqfw-android-stb-jellybean-cfg80211-noproptxstatus
elif [ "${CHIPVER}" == 43242a1 ] ; then
	export BUILDCFG_COMMON=dhd-cdc-usb-reqfw-android-stb-jellybean-cfg80211-comp
elif [ "${CHIPVER}" == 43569a0 ] ; then
	export BUILDCFG_COMMON=dhd-cdc-usb-reqfw-android-stb-jellybean-cfg80211-comp-mfp
elif [ "${CHIPVER}" == 43570a0 ] ; then
	echo "43570 does not support reqfw"
	exit
else
	export BUILDCFG_COMMON=dhd-cdc-usb-reqfw-android-stb-jellybean-cfg80211
fi
