 ...
 *
 * $Id: tkhash.c 451682 2014-01-27 20:30:17Z $
 */
 ...
 */
void
tkhash_phase1(uint16 *P1K, const uint8 *TK, const uint8 *TA, uint32 IV32)
{
	uint16 i;
 ...
 */
void
tkhash_phase2(uint8 *RC4KEY, const uint8 *TK, const uint16 *P1K, uint16 IV16)
{
	uint16 i;
