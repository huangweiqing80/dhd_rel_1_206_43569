 ...
 *
 * $Id: sha1.c 451682 2014-01-27 20:30:17Z $
 *
 * From rfc3174.txt
 */
 ...
 */
int
SHA1Result(SHA1Context *context, uint8 Message_Digest[SHA1HashSize])
{
	int i;
 ...
 */
int
SHA1Input(SHA1Context *context, const uint8 *message_array, unsigned length)
{
	if (!length) {
		return shaSuccess;
	}
