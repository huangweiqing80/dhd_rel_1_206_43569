 ...
 *
 * $Id: dhd.h 477972 2014-05-15 05:11:49Z $
 */
...
/* Disable per flowring queue Spin Lock/Unlock when perimeter lock is in use */
#define DHD_QUEUE_LOCK(lock, flags)       ({ BCM_REFERENCE(flags); })
#define DHD_QUEUE_UNLOCK(lock, flags)     ({ BCM_REFERENCE(flags); })
