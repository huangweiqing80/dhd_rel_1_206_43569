 ...
 *
 * $Id: dhdu.c 478165 2014-05-15 21:58:53Z $
 */
...
cmd_t dhd_cmds[] = {
	...
	{ "bar0secwinreg", dhd_reg2args, DHD_GET_VAR, DHD_SET_VAR,
	"get/set bar0 secondary window register from the device"},
	...
	{"dhcp_unicast", dhd_varint, DHD_GET_VAR, DHD_SET_VAR,
	"enable/disable DHCP unicast conversion feature"},
	{"block_ping", dhd_varint, DHD_GET_VAR, DHD_SET_VAR,
	"enable/disable inter STA's ping"},
	{"grat_arp", dhd_varint, DHD_GET_VAR, DHD_SET_VAR,
	"enable/disable gratutious arp features"},
...
failed_retry:
		...
		ret = dhd_set(dhd, DHD_SET_VAR, &buf[0], (int)(bufp - buf + len));
