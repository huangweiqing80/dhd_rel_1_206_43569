...
#ifndef ANDROID_P2P
		/* Always pass the BSSID for association (Even When the driver
		 * based roaming is enabled in the firmware) BSSID and freq is
		 * passed in order to reduce the time taken for initial
		 * association */
