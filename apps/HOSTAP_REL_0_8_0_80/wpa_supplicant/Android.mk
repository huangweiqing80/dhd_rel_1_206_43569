...
#++++++++++++++++++++++++++++++++++++++++++++++++++++++
# Board specific defines: Defined here for internal
# BCM use. Real targets should define these in the 
# Platform specific files in the vendor/device directory.
...
ifdef CONFIG_BRCM_OKC
L_CFLAGS += -DBRCM_OKC
endif

ifdef CONFIG_BRCM_CCX
L_CFLAGS += -DBRCM_CCX
endif
...
L_CFLAGS += -DBCM_GENL -DBCM_SDO
# Enable BCM_MAP_SDCMDS_2_SDOCMDS to map old wpa_cli commands to SD offloaded Commands
#L_CFLAGS += -DBCM_MAP_SDCMDS_2_SDOCMDS
endif

ifdef CONFIG_BRCM_BEST_CHANNEL
L_CFLAGS += -DCONFIG_BRCM_BEST_CHANNEL
endif

ifdef CONFIG_BRCM_SD_DYNAMIC_CAPA
L_CFLAGS += -DCONFIG_BRCM_SD_DYNAMIC_CAPA
endif

ifeq ($(BOARD_WLAN_DEVICE), bcmdhd)
L_CFLAGS += -DANDROID_P2P -DBRCM_DEBUG -DSUP_SRC_BASE=\"$(LOCAL_PATH)\"
...
# OpenSSL is configured without engines on ICS Android
L_CFLAGS += -DOPENSSL_NO_ENGINE -DICS
endif
ifneq ($(findstring 4.1,$(PLATFORM_VERSION)),)
# For JB
L_CFLAGS += -DJB
endif
...
ifdef CONFIG_BRCM_CCX
INCLUDES += $(LOCAL_PATH)/src/brcm_supp
endif
...
ifdef CONFIG_WIFI_DISPLAY_NFC_BCM
L_CFLAGS += -DCONFIG_WIFI_DISPLAY_NFC_BCM
endif

ifdef CONFIG_BRCM_WFDS
L_CFLAGS += -DWLWFDS
endif
...
L_CFLAGS += -DCONFIG_WPS_NFC_BCM
OBJS += src/wps/ndef.c
NEED_WPS_OOB=y
endif

ifdef CONFIG_P2P_NFC
ifndef CONFIG_WPS_NFC
$(error CONFIG_WPS_NFC need to be enabled)
endif
L_CFLAGS += -DCONFIG_P2P_NFC
L_CFLAGS += -DCONFIG_IP_ALLOC
endif
...
LOCAL_STATIC_LIBRARIES += $(BOARD_WPA_SUPPLICANT_PRIVATE_LIB)_supplicant
endif
LOCAL_SHARED_LIBRARIES := libc libcutils liblog
